 ...
 */
/**
 * Test suite for the `GET` handler in `/api/auth/version`.
 *
 * This suite verifies:
 * - Proxies the version request to the authentication service
...
describe("GET /api/auth/version", () => {
  ...
  const buildReq = () => {
    return {
      ...
      url: "http://localhost:3000/api/auth/version",
      headers: {
