...
describe('GET /api/project/projects/[project_id]/roles/[role_id]/policies', () => {
  ...
  const buildReq = () => {
    return {
      ...
      headers: new Headers(),
      url: `http://localhost:3000/api/project/projects/${projectId}/roles/${roleId}/policies`,
  ...
  it('should return list of policies for role', async () => {
    const req = buildReq();
