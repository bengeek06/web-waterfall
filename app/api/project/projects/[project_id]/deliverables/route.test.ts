...
describe('/api/project/projects/[project_id]/deliverables', () => {
  ...
  const buildReq = (method = 'GET', body?: string) => {
    return {
      ...
      headers: new Headers(),
      url: `http://localhost:3000/api/project/projects/${projectId}/deliverables`,
      method,
  ...
  describe('GET', () => {
    it('should return list of deliverables', async () => {
      const req = buildReq();
