...
describe('GET /api/project/projects/[project_id]/wbs-structure', () => {
  ...
  const buildReq = () => {
    return {
      ...
      headers: new Headers(),
      url: `http://localhost:3000/api/project/projects/${projectId}/wbs-structure`,
  ...
  it('should return WBS structure', async () => {
    const req = buildReq();
